...
echo $IGOR_PREFIX -batch $EVAL_BATCH_NAME -infer -output --scenarios $NUM_SCENARIOS
$IGOR_PREFIX -batch $EVAL_BATCH_NAME -infer -output --scenarios $NUM_SCENARIOS 

echo $IGOR_PREFIX -batch $GEN_BATCH_NAME -load_last_inferred -generate $NUM_GEN_SEQUENCES --CDR3
$IGOR_PREFIX -batch $GEN_BATCH_NAME -load_last_inferred -generate $NUM_GEN_SEQUENCES --CDR3
